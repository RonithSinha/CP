...
for i in range(edges):
    ...
    graph[vertexDict[x[0]]][vertexDict[x[1]]]=1
print(graph)
startVertex=int(input())
endVertex=int(input())
g=Graph(graph)
print(vertexDict[startVertex],vertexDict[endVertex])
g.minCut(vertexDict[startVertex],vertexDict[endVertex])
